    ...
    Highcharts.stockChart( this.container.nativeElement, {
      ...
      subtitle: {
        text: document.ontouchstart === undefined ?
                'Click and drag in the plot area to zoom in on Y' : 'Pinch the chart to zoom in on Y'
    },
    yAxis: {
      title: {
          text: 'Snow depth (m)'
      ...
      plotLines: [
        {
          color: '#FF0000',
          width: 2,
          value: Date.UTC(1970, 11, 25)
        },
        {
          color: '#FF0000',
          width: 2,
          value: Date.UTC(1971, 2, 14)
        }, {
          color: '#FF0000',
          width: 2,
          value: Date.UTC(1971, 5, 4)
        }
      ]
    },
    tooltip: {
